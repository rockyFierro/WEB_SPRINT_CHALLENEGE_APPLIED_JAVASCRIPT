...
1. What is the DOM?
  the document object model is created by the browser to model your code. it is not your code. it is a representation
2. What is an event?
  an event is an action that occurs on your page that can be handled ; it can be used to trigger a reaction or response.
3. What is an event listener?
  an event listener can be appended to an object to listen and respond to a particular event
4. Why would we convert a NodeList into an Array?
  to easier mutate or manage the information found in the NodeList with methods reserved for arrays.
5. What is a component?
  a reusable chunk of code made up of smaller objects.
